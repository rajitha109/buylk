					...
					<div class="row">
                        ...
                        <div class="col-sm-5">
                                ...
                                <div class="panel panel-warning">
                                    ...
                                    <div class="panel-body">
                                        <form action="contact_us.php" method="post" role="form">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <textarea name="message" placeholder="Enter your message" class="form-control" width="20" height="10"  required></textarea>
                                            </div>    
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="submit" name="contact"  class="btn btn-success btn-lg btn-block" value="Contact Us">
                                            </div>
